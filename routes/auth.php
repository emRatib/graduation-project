...
Route::post('/login/employee', [EmployeeController::class, 'store'])->middleware('guest')->name('login.employee');

Route::post('/logout/employee', [EmployeeController::class, 'destroy'])->name('logout.employee');
