                    ...
                    <div class="row" id="row">
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                <input value="{{ $doctor->name }}" type="text" name="name" id="firstName"
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                <input value="{{ $doctor->email }}" type="email" name="email" id="lastName"
                                    class="form-control form-control-lg" />
                                <label class="form-label" for="lastName">Email Editress</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-4 d-flex align-items-center">
                            <div class="form-outline datepicker w-100">
                                <input name="password" type="password" class="form-control form-control-lg"
                                    id="birthdayDate" readonly />
                                <label for="birthdayDate" class="form-label">Password</label>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 d-flex align-items-center">
                            <div class="form-outline datepicker w-100">
                                <input value="{{ $doctor->phone }}" name="phone" type="tel"
